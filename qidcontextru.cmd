...
@echo    %_fBRed%+++ Это неподходящий для обработки файл или каталог +++
@echo.
@echo    %_fBYellow%Выберите файлы ab, apk, install.txt или каталог с игрой%_fReset%
@echo    Также проверьте, чтобы в имени каталогов или файлов не было восклицательных знаков.
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo    %_fBRed%+++ This is an unsuitable file or directory for processing +++
rem @echo.
rem @echo    %_fBYellow%Select ab, apk, install.txt files or a game directory%_fReset%
rem EndEngTextBlock
@echo --------------------------------------------------------------
@echo.
goto :_exitout
...
@echo ==========================================================
rem StartRusTextBlock
@echo  %_fBGreen%= Установка "!dlfile!"%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBRed%= Installing "%dlfile%"%_fReset%
rem EndEngTextBlock
if not exist "!dlappl!" (
rem StartRusTextBlock
@echo  %_fBRed%= Файл не найден:%_fReset% !dlappl!
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBRed%= File not found:%_fReset% %dlappl%
rem EndEngTextBlock
goto :_exitout
)
...
rem StartRusTextBlock
@echo  %_fBRed%= Неподдерживаемый формат:%_fReset% !ext!
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBRed%= Unsupported format:%_fReset% %ext%
rem EndEngTextBlock
goto :_exitout
)
rem StartRusTextBlock
@echo  %_fBYellow%= Распаковка%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBRed%= Unpacking%_fReset%
rem EndEngTextBlock
...
if errorlevel 1 (
rem StartRusTextBlock
@echo  %_fBRed%= Ошибка распаковки%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBRed%= Unpacking error%_fReset%
rem EndEngTextBlock
goto :_exitout
)
set "APK_BASE="
...
rem StartRusTextBlock
@echo  %_fBRed%= APK не найдены%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBRed%= APK files not found%_fReset%
rem EndEngTextBlock
goto :_exitout
)
if defined APK_BASE (
rem StartRusTextBlock
@echo  %_fBGreen%= base.apk найден%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBGreen%= base.apk found%_fReset%
rem EndEngTextBlock
) else (
rem StartRusTextBlock
@echo  %_fYellow%= base.apk не найден%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fYellow%= base.apk not found%_fReset%
rem EndEngTextBlock
)
rem ==================================================
...
rem StartRusTextBlock
@echo  %_fBCyan%= Порядок установки:%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem  @echo %_fBCyan%= Installation order:%_fReset%
rem EndEngTextBlock
...
set "errorsLog=ErrorsLog.txt"
rem StartRusTextBlock
@echo  %_fBYellow%= Установка APK...%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo  %_fBYellow%= Installing APK...%_fReset%
rem EndEngTextBlock
...
if errorlevel 1 (
rem StartRusTextBlock
@echo  %_fBRed%= Ошибка установки APK%_fReset%
@echo  -----------------------------------------
@echo  %_fBYellow%Подробности содержатся в файлах %_fYellow%InstallLogt.txt%_fBYellow% и %_fYellow%ErrorsLog.txt%_fBYellow%
@echo  расположенных в каталоге %_fYellow%%systemdrive%\Temp\SendToHeadset%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo  %_fBRed%= APK installation error%_fReset%
rem EndEngTextBlock
...
rem StartRusTextBlock
@echo  %_fBYellow%= Копирование OBB...%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo  %_fBYellow%= OBB files copying...%_fReset%
rem EndEngTextBlock
%MYFILES%\adb push "%dlcat%\Android\obb" /sdcard/Android/
) else (
rem StartRusTextBlock
@echo  %_fYellow%= OBB не найден%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo  %_fYellow%= OBB files not found%_fReset%
rem EndEngTextBlock
)
)
@echo.
@echo ===============================================
rem StartRusTextBlock
@echo      %_fBGreen%=== Установка завершена ===%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo      %_fBGreen%=== Installation complete ===%_fReset%
rem EndEngTextBlock
rd /s /q "!dlcat!" 1>nul 2>nul
goto :_exittimeout
...
@echo  %_fBGreen%+++ Установка завершена +++%_fReset%
@echo.
@echo   %_fBYellow%Установлено		: !MultiCounterOk!%_fReset%
@echo   %_fYellow%Не установлено	: %MultiCounterEr%%_fReset%	
@echo --------------------------------------------
@echo.
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo %_fBGreen%+++ Installation completed +++%_fReset%
rem @echo.
rem @echo   %_fBGreen%Installed		: !MultiCounterOk!%_fReset%
rem @echo   %_fBRed%Not installed	: %MultiCounterEr%%_fReset%
rem @echo --------------------------------------------
rem @echo.
rem EndEngTextBlock
@echo.
...
rem StartRusTextBlock
@echo  %_fBYellow%%MultiCounter%%_fReset%. = Устанавливаем  "%_fBCyan%%applabel%%_fReset%"
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo %_fBYellow%%MultiCounterOk%%_fReset%. = Installing "%_fBCyan%%applabel%%_fReset%"
rem EndEngTextBlock
...
set "FoundPath=%%i"
rem StartRusTextBlock
@echo     = Копируем "%_fCyan%%pkgname%%_fReset%" в каталог OBB на шлем..
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo     = Copying "%_fCyan%%pkgname%%_fReset%" to the OBB directory on the headset..
rem EndEngTextBlock
...
:_MultiInstallApkErr
rem StartRusTextBlock
@echo     %_fBRed%+++ Ошибка установки приложения %_fBCyan%!apknamefile! %_fBRed%+++%_fReset%
@echo     -----
@echo  %_fBYellow%Подробности содержатся в файлах %_fYellow%InstallLogt.txt%_fBYellow% и %_fYellow%ErrorsLog.txt%_fBYellow%
@echo  расположенных в каталоге %_fYellow%%systemdrive%\Temp\SendToHeadset%_fReset%
@echo     -----
@echo     %_fCyan%= Продолжаем установку%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo  %_fBRed%+++ Installation error %_fBCyan%!apknamefile! +++%_fReset%
rem @echo     -----
rem @echo  %_fBYellow%Details can be found in the files %_fYellow%InstallLogt.txt%_fBYellow% and %_fYellow%ErrorsLog.txt%_fBYellow%
rem @echo  located in the directory %_fYellow%%systemdrive%\Temp\SendToHeadset%_fReset%
rem @echo     -----
rem @echo  %_fBYellow%= Continuing installation%_fReset%
rem EndEngTextBlock
...
rem @echo --
rem StartRusTextBlock
@echo     %_fBGreen%= Установлено успешно%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo     %_fBGreen%= Successfully installed%_fReset%
rem EndEngTextBlock
...
@echo -----------------------------------------------
rem StartRusTextBlock
@echo  = Устанавливаем "%_fBCyan%%applabel%%_fReset%"
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo = Installing "%_fBCyan%%applabel%%_fReset%"
rem EndEngTextBlock
...
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo %_fBRed%+++ Installation Error +++%_fReset%
rem @echo.
rem @echo  %_fBYellow%Details can be found in the files %_fYellow%InstallLogt.txt%_fBYellow% and %_fYellow%ErrorsLog.txt%_fBYellow%
rem @echo  located in the directory %_fYellow%%systemdrive%\Temp\SendToHeadset%_fReset%
rem EndEngTextBlock
...
@echo  ===========================================
rem StartRusTextBlock
@echo  %_fBYellow%= Установка по сценарию%_fReset% %_fYellow%install.txt%_fReset%
@echo.
@echo    %_fBYellow%Если во время установки возникнут ошибки,
@echo    они будут записаны в файл %_fYellow%errors.txt%_fReset% %_fBYellow%в каталоге с игрой.%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo %_fBYellow%== Installation via install.txt script
rem @echo.
rem @echo    If errors occur during installation,
rem @echo    they will be recorded in the errors.txt file in the game directory.%_fReset%
rem EndEngTextBlock
@echo  -----
...
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo %_fBGreen%+++ Installation is complete +++%_fReset%
rem EndEngTextBlock
@echo.
goto :_exittimeout
rem exit /b
...
@echo               или подождите десять секунд
rem EndRusTextBlock
rem StartEngTextBlock
...
@echo.
rem StartRusTextBlock
@echo     %_fBRed%+++++ Шлем не найден +++++%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo     %_fBRed%+++++ Headset not found +++++%_fReset%
rem EndEngTextBlock
@echo.
@echo.
@echo.
rem StartRusTextBlock
@echo  %_fBYellow%Проверьте кабельное соединение и правильность установки драйверов.
@echo  Затем перезапустите эту программу снова.%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo  %_fBYellow%Check the cable connection and the correctness of the driver installation.
rem @echo  Then restart this program again.%_fReset%
rem EndEngTextBlock
@echo.
@goto _exitout
...
@echo    = Название архива	: %_fBCyan%!filename!%_fReset%
@echo    = Название пакета	: %_fCyan%!viewpn!%_fReset%
@echo   ------------------------------------------------------------------
@echo    %_fBYellow%Для подтверждения восстановления нажмите %_fYellow%Enter%_fBYellow%, для выхода - %_fYellow%Esc%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo    %_fBYellow%Preparing for restore. Do not interrupt this process.%_fReset%
rem @echo   -------------------------------------------------------------------
rem call :_PackageNameExtract
rem @echo    = Archive name	: %_fBCyan%!filename!%_fReset%
rem @echo    = Package name	: %_fCyan%!viewpn!%_fReset%
rem @echo   ------------------------------------------------------------------
rem @echo   %_fBYellow%For restore confirmation press %_fYellow%Enter%_fBYellow%, to exit - %_fYellow%Esc%_fReset%
rem EndEngTextBlock
@echo   ------------------------------------------------------------------
...
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo            %_fBYellow%This window will close in ten seconds%_fReset%
rem EndEngTextBlock
timeout 10 >nul
exit
