...
rem @echo   ---
rem @echo     Вы можете найти их здесь: %_fBYellow%%cd%\Backups\!applabelsave!\data%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
...
rem @echo       ==============================================================
rem @echo.   
rem @echo       Для извлечения файлов необходим подключенный к ПК шлем
rem @echo       Проверьте соединение и установку драйверов
rem @echo.
rem exit /b
ver 4.3.2
