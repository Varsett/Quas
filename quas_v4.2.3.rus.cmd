...
rem @echo       and restart the service. It will also delete all fba files in the root of the C drive
rem @echo       and in the directory %USERPROFILE%\AppData\Local\Temp
rem EndEngTextBlock
@echo.
@echo.
call :_MenuChoiceEnter
...
@echo ║                                                                                                ║
@echo ║        %_fBRed%Автор программы не несет ответственность за риск окирпичания шлема %_fReset%                     ║
@echo ║                                                                                                ║
@echo ╚════════════════════════════════════════════════════════════════════════════════════════════════╝
rem EndRusTextBlock
rem StartEngTextBlock
...
@echo  ============================================================================
rem StartRusTextBlock
@echo  ^|  +++    Время или таймзона различаются, требуется корректировка    +++   ^|
rem EndRusTextBlock
rem StartEngTextBlock
...
@echo.
@echo     Для включения и отключения файрволла, а также для добавления или удаления правила
@echo     программа Quas должна быть запущена с правами администратора.
rem EndRusTextBlock
rem StartEngTextBlock
