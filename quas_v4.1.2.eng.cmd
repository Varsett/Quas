...
::@cls
@echo ==================================================================================================
@echo        Quest Update Tool - created by Varset - v.1.4 - 13.08.23
@echo ==================================================================================================
@exit /b
...
set curllink=https://www.dropbox.com/scl/fi/5k90nm5z01v4eal7fnvku/xyz.skybox.player.ovr.apk?rlkey=dz5jfnp7jdm7kb0xq23iq1hl0
call :_dlinstall
call :_prevmenu
goto _InstallSoftwareApps
...
set curllink=https://www.dropbox.com/scl/fi/dlf05gqkkhgcn0i608sfk/com.hanginghatstudios.pigasus.apk?rlkey=dbdkjtlms140nd09s9f61wa0p
call :_dlinstall
call :_prevmenu
goto _InstallSoftwareApps
...
set curllink=https://www.dropbox.com/scl/fi/h5havtw8y9ys1bm7ew8lq/cn.vr4p.oculus4xvrplayerov.apk?rlkey=761eairh8wgoh5t0br4qx5nz6
call :_dlinstall
call :_prevmenu
goto _InstallSoftwareApps
...
:_moonplayerinst
call :_cdc
set dlappl=mr.com.rockvr.moonplayer.apk
set curllink=https://www.dropbox.com/scl/fi/6q5c2tipr70mkb347gfa5/com.rockvr.moonplayer.apk?rlkey=0nvp1xhmwn43zqs8uhik6bxnx
call :_dlinstall
call :_prevmenu
goto _InstallSoftwareApps
...
set curllink=https://www.dropbox.com/scl/fi/w2ig8dvc9d1z99l0axyub/com.heresphere.vrvideoplayer.apk?rlkey=xuupc32840rkeuipfxuqu9o2t
call :_dlinstall
call :_prevmenu
goto _InstallSoftwareApps
...
rem EndEngTextBlock
@echo @echo.>>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
@echo @%sendtofoldercmdfolder%\adb.exe push "!fullpathfile!!file!" -p "/sdcard/">>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
@echo @%sendtofoldercmdfolder%\adb shell mv /sdcard/!file! "%qtarget%">>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
@echo ^)>>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
@echo.>>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
@echo @echo.>>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
@echo @echo ^====================================================>>%sendtofoldercmdfolder%\%sendtofoldercmdfile%
...
rem EndRusTextBlock
rem StartEngTextBlock
if %dd%==1 set cropset=1584:1440:1950:250 & set cropmsg=Corners crop
...
rem @echo.
rem @echo    После запуска теста (пункт S) введите значения или нажмите Enter для значений по умолчанию:
...
rem @echo      - Длительность проверки в секундах, от 30 до 3600: 		(по умолчанию - 180)
...
rem @echo    отключите файрволл на ПК на время тестирования.
rem @echo.
...
rem @echo    результаты и покажет их. Также рядом с программой будет сохранена картинка с результатами.
rem EndRusTextBlock
rem StartEngTextBlock
call :_hatmenu
@echo.
...
@echo    test, and display them. Additionally, an image with the results will be saved next to program.
rem EndEngTextBlock
@echo  ---------
rem @echo.
call :_MenuChoiceEnter
...
rem @echo   Затем перезапустите эту программу
rem @echo   Если окно не появляется, перезагрузите шлем.
rem @echo.
...
@echo.
rem StartRusTextBlock
rem @echo     +++ Подключенное утройство не выглядит как шлем  +++
rem @echo.
