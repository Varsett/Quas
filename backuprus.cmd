...
rem StartRusTextBlock
@echo   %_fBYellow%= Приложение отсутствует%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo   %_fBYellow%= Application is missing%_fReset%
rem EndEngTextBlock
exit /b
)
set "pname="
...
if "!errorlevel!"=="1" (
rem StartRusTextBlock
@echo   %_fBYellow%- Приложение на шлеме не найдено%_fReset%
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo   %_fBYellow%- The application not found on the headset%_fReset%
rem EndEngTextBlock
exit /b
)
