...
@echo.
rem StartRusTextBlock
@echo   = Копирование пакета	: !pkgnamef!
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo   = Package copying	: !pkgnamef!
rem EndEngTextBlock
...
@echo   -----------------
rem StartRusTextBlock
@echo   = Приложение скопировано	: !applabel!
rem EndRusTextBlock
rem StartEngTextBlock
...
@echo   ---
rem StartRusTextBlock
@echo     Копирование OBB	: !pkgnamef!
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo   = OBB app copying	: !pkgnamef!
rem EndEngTextBlock
if [!applabel!]==[] set applabel=!pkgnamef!
...
@echo   ---
rem StartRusTextBlock
@echo     Копирование данных	: !pkgnamef!
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo   = Data app copying	: !pkgnamef!
rem EndEngTextBlock
if [!applabel!]==[] set applabel=!pkgnamef!
...
if [%allappscase%]==[1] (
rem StartRusTextBlock
@echo   +++ Выберите только одно приложение +++
rem EndRusTextBlock
rem StartEngTextBlock
rem @echo   +++ Select only one application +++
rem EndEngTextBlock
@echo.
call :_PressAnyKey
exit /b
...
@echo   ---
rem StartRusTextBlock
@echo   +++  Обнаружен запрет доступа. Запущен альтернативный метод бэкапа +++
rem EndRusTextBlock
rem StartEngTextBlock
...
@echo   ================================================================
rem StartRusTextBlock
@echo       Старт архивации по выбору.  Не прерывайте этот процесс.
...
@echo   ================================================================
rem StartRusTextBlock
@echo        Старт архивации по списку.  Не прерывайте этот процесс.
@echo   Лог архивации %dt% >>ArchiveLog-%dt%.txt
rem EndRusTextBlock
rem StartEngTextBlock
...
@echo   ================================================================
rem StartRusTextBlock
@echo         Старт полной архивации.  Не прерывайте этот процесс.
@echo   Лог архивации %dt% >>ArchiveLog-%dt%.txt
rem EndRusTextBlock
rem StartEngTextBlock
